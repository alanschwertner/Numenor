    ...
    $.widget('ui.spinner', {
        ...
        _createButtons: function(input) {
            ...
            btnContainer = self.btnContainer = $(
                ...
                '<div class="ui-spinner-up ui-spinner-button ui-state-default"><span class="ui-icon '+options.upIconClass+'">&nbsp;</span></div>' +
                '<div class="ui-spinner-down ui-spinner-button ui-state-default"><span class="ui-icon '+options.downIconClass+'">&nbsp;</span></div>' +
                '</div>'),
            ...
            buttons.css({
                ...
                height: height/2 - (box ? buttons.outerHeight() - buttons.height() : 0)
            });
            upButton = buttons[0];
