...
;(function($){
	$.contextMenu = {
		...
		createShadow: function(cmenu) {
			cmenu.shadowObj = $('<div class="'+cmenu.shadowClass+'"></div>').css( {display:'none',position:"absolute", zIndex:997, opacity:cmenu.shadowOpacity, backgroundColor:cmenu.shadowColor } );
		...
		show: function(t,e) {
			...
			if (cmenu.beforeShow()!==false) {
				...
				$c.css( {top:pos.y+"px", left:pos.x+"px", position:"absolute",zIndex:998} )[cmenu.showTransition](cmenu.showSpeed,((cmenu.showCallback)?function(){cmenu.showCallback.call(cmenu);}:null));
				cmenu.shown=true;
